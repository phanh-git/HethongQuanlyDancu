...
const Layout = () => {
  ...
  const menuItems = [
    ...
    { text: 'Hộ khẩu', icon: <HomeIcon />, path: '/households' },
    { text: 'Nhân khẩu', icon: <PeopleIcon />, path: '/population' },
    { text: 'Tạm trú/Tạm vắng', icon: <AssignmentIcon />, path: '/temporary-residence' },
    { text: 'Kiến nghị', icon: <AssignmentIcon />, path: '/complaints' },
