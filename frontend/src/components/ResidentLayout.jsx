...
const ResidentLayout = () => {
  ...
  const menuItems = [
    ...
    { text: 'Dịch vụ trực tuyến', icon: <MoveToInbox />, path: '/home/services' },
    { text: 'Gửi phản ánh', icon: <AssignmentIcon />, path: '/home/complaints' },
    { text: 'Thông báo', icon: <Notifications />, path: '/home/notifications' }
  ];
